...
export default function JobCard({ job, onEdit, onDelete, onSelect }) {
  ...
  // SCRUM-36: urgency + stale indicators
  const now = new Date();
  ...
  return (
    <div className={`job-card${isStale ? " job-card-stale" : ""}`}>
      <div className="job-card-header">
        ...
        <div className="job-card-badges">
          ...
          {isStale && <span className="job-stale-badge">Stale</span>}
        </div>
      </div>
